...
import com.example.recycleview.adapter.MovieAdapter
import com.example.recycleview.model.ModelMovie


class RecycleViewMovie : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        movieAdapter = MovieAdapter(this@RecycleViewMovie, movieList) { position ->
    ...
    private fun showDetailDialog(position: Int) {
        val intent = Intent(this, fotodetail::class.java)
